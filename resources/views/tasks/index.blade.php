        ...
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <td>{{ $task->title }}</td>
              <td>
                @if($task->status_label == '未着手')
                <span class="label label-danger">{{$task->status_label}}</span>
                @elseif($task->status_label == '着手中')
                <span class="label label-info">{{$task->status_label}}</span>
                @else
